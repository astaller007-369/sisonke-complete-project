...
if active_app_tab == "🗂️“ Research & Sentiment Tracker":
    ...
    if not master_db_df.empty and "status" in master_db_df.columns and league_col_target is not None:
        fixture_mask = (master_db_df[league_col_target] == selected_league) & (master_db_df["status"] == "NS")
